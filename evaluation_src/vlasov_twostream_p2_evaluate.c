...
int main(int argc, char **argv)
{
  ...
  int sz_training_final = snprintf(0, 0, fmt_training_final, 100);
  char file_nm_training_final[sz_training_final + 1];
  snprintf(file_nm_training_final, sizeof file_nm_training_final, fmt_training_final, 100);
  ...
  int sz_validation_final = snprintf(0, 0, fmt_validation_final, 100);
  char file_nm_validation_final[sz_validation_final + 1];
  snprintf(file_nm_validation_final, sizeof file_nm_validation_final, fmt_validation_final, 100);
